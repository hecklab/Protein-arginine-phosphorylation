...
```{r}
pRHSTY.Ecoli <- read.delim("MQ_output_txt/Endogenous_data/Ecoli/Phospho (RHSTY)Sites_Ecoli.txt", header = TRUE,
                           stringsAsFactors = FALSE, dec = ".")
pRHSTY.Bsub <- read.delim("MQ_output_txt/Endogenous_data/Bsubtilis/Phospho (RHSTY)Sites_sub.txt", header = TRUE,
                           stringsAsFactors = FALSE, dec = ".")
phospho_SdrE <- read.delim("MQ_output_txt/Endogenous_data/SdrE/Phospho (RHSTY)Sites_SdrE.txt", header = TRUE, stringsAsFactors = FALSE, dec = ".")
...
Plot percentage of pArg sites for the thre different organisms
