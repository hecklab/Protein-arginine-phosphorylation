...
Stability.test.msms <- read.delim("MQ_output_txt/Synthetic_peptides/Stability_4C/txtStability_test/msms.txt", header = TRUE, stringsAsFactors = FALSE, dec = ".")
...
Stability.test.msms.on <- read.delim("MQ_output_txt/Synthetic_peptides/Stability_room_temp/txt/Stability_test/on/msms.txt", header = TRUE, stringsAsFactors = FALSE, dec = ".")
```
